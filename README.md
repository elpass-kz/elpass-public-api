...
class ElpassCardManager:
    ...
    def create_card(self, resident_uuid, name, object_guid, photo_path, group=None, entrance_number=None, **kwargs):
    ...
    def update_card(self, card_uuid, photo_path=None, **fields):
        ...
        for key in ["name", "begin_at", "end_at", "passType", "group", "meta", "entranceNumber"]:
            if key in fields:
                data[key] = fields[key]
